...
simulation.reporters.append(XTCReporter('Cterm0719xtc.xtc', 1000))
simulation.reporters.append(StateDataReporter('Cterm0719csv.csv', 1000, time=True, temperature=True, kineticEnergy=True, potentialEnergy=True))
simulation.reporters.append(PDBReporter('Cterm0719pdb.pdb', 250000))
